...
Todos los despliegues dedicados de {{site.data.keyword.Bluemix_notm}} incluyen los siguientes beneficios y características sin ningún coste adicional: VPN, red de área local virtual privada (VLAN), cortafuegos, optimización de las apps y bases de datos locales existentes, seguridad local 24 horas al día/7 días por semana, hardware dedicado y soporte estándar.
...
| Opcional | [{{site.data.keyword.dashdbshort}}](/docs/services/Db2whc/index.html#getting_started) | IBM {{site.data.keyword.dashdbshort}} es un servicio de base de datos de nube de SQL totalmente gestionado, optimizado para el almacén de datos y las cargas de trabajo de análisis. |
| Opcional | [{{site.data.keyword.Db2_on_Cloud_short}}](/docs/services/Db2onCloud/index.html#getting_started_db2oncloud) | IBM {{site.data.keyword.Db2_on_Cloud_short}} es un servicio de base de datos de nube de SQL totalmente gestionado, optimizado para el uso general, las apps web y las cargas de trabajo transaccionales. |
...
|{{site.data.keyword.Bluemix_dedicated_notm}} {{site.data.keyword.Db2_on_Cloud_short}} Precise Performance 500 (2.8.500) | Instancia dedicada que soporta cargas de trabajo de proceso de transacción en línea (OLTP) con 8 GB de RAM y 500 GB de espacio para datos y registros. |
|{{site.data.keyword.Bluemix_dedicated_notm}} {{site.data.keyword.Db2_on_Cloud_short}} Precise Performance 1400 (12.128.1400) | Instancia dedicada que soporta cargas de trabajo de proceso de transacción en línea (OLTP) con 128 GB de RAM y 1.4 TB de espacio SSD para datos y registros. |
|{{site.data.keyword.Bluemix_dedicated_notm}} {{site.data.keyword.Db2_on_Cloud_short}} Precise Performance 500 High Availability (2.8.500) | Instancia dedicada que soporta cargas de trabajo de proceso de transacción en línea (OLTP) con 8 GB de RAM y 500 GB de espacio para datos y registros e incluye un servidor en espera adicional para alta disponibilidad. |
|{{site.data.keyword.Bluemix_dedicated_notm}} {{site.data.keyword.Db2_on_Cloud_short}} Precise Performance 1400 High Availability (12.128.1400) | Instancia dedicada que soporta cargas de trabajo de proceso de transacción en línea (OLTP) con 128 GB de RAM y 1.4 TB de espacio SSD para datos y registros e incluye un servidor en espera adicional para alta disponibilidad. |
...
|Servicio	|Disponible en la región EE.UU. sur	|Disponible en la región Europa Reino Unido |Disponible en la región Alemania |Disponible en la región EE.UU. este|Disponible en la región Australiana Sídney|
|:----------|:------------------------------|:------------------|:------------------|:------------------|:--------------|
|{{site.data.keyword.alertnotificationshort}} | Sí | Sí | No | No | Sí |
|{{site.data.keyword.appseccloudshort}}		| Sí | Sí | No | No | Sí |
|Comprobador de accesibilidad automatizado |Sí       |Sí    |Sí   | No  | Sí |
|{{site.data.keyword.cloudant}}			| Sí		| Sí		| Sí | Sí  | Sí |
|{{site.data.keyword.evtmgt_short}} | Sí | Sí | No | No | Sí |
|{{site.data.keyword.iotmapinsights_short}}    | Sí  | Sí  | No  | No | Sí |
|{{site.data.keyword.uccr_short}} | Sí | No | No | No | No |
|{{site.data.keyword.conversationshort}}  | Sí  | Sí  | Sí  | No | Sí |
|{{site.data.keyword.dataworks_short}}		| Sí		| Sí		| No | No | No |
|Db2 alojado | Sí | Sí | Sí | No | Sí |
|{{site.data.keyword.DB2OnCloud_short}}		| Sí		| Sí		| Sí | No | Sí |
|{{site.data.keyword.dashdbshort_notm}} | Sí | Sí | Sí | No | Sí |
|Comprobador de contenido digital | Sí  | Sí  | No | No | Sí |
|{{site.data.keyword.servicediscoveryshort}} | Sí | Sí | No | No | Sí |
|{{site.data.keyword.documentconversionshort}}	| Sí		| Sí		| No | No | Sí |
|{{site.data.keyword.iotdriverinsights_short}}  | Sí | Sí | No | No | Sí |
|{{site.data.keyword.geospatialshort_Geospatial}}	| Sí	| Sí		| No | No  | Sí |
|{{site.data.keyword.GlobalizationPipeline_short}}	| Sí		| Sí		| Sí | No | Sí |
|{{site.data.keyword.identitymixershort}}		| Sí		| Sí		| No | No | Sí |
|{{site.data.keyword.iot4auto_short}} | Sí   | Sí  | No | No | Sí |
|{{site.data.keyword.iotelectronics}}  | Sí  | Sí  | No | No | No |
|{{site.data.keyword.languagetranslatorshort}} | Sí | Sí | Sí | No | Sí |
|{{site.data.keyword.dwl_short}}  | Sí  | Sí  | No  | No | No |
|{{site.data.keyword.pm_short}} | Sí | Sí | No | No | No |
|{{site.data.keyword.messagehub}}		| Sí		| Sí		| Sí | No | Sí |
|{{site.data.keyword.manda}}			| Sí		| Sí		| Sí | No | Sí |
|{{site.data.keyword.nlclassifiershort}} 	| Sí 		| Sí 		| No | No  | Sí |
|{{site.data.keyword.nlushort}} | Sí | Sí | No | No | Sí |
|{{site.data.keyword.personalityinsightsshort}}	| Sí		| Sí		| Sí | No | Sí |
...
|Crear una variación de tamaño para los entornos |  	Crear una variación de tamaño de los entornos en función de opciones predefinidas que tengan en cuenta los objetivos de alta disponibilidad y la recuperación en caso de error, así como el CELL inicial y el suministro de servicios necesario para dar soporte a las apps creadas con la plataforma. Usted e IBM trabajan conjuntamente para definir, por ejemplo, qué bases de datos son necesarias, qué servicios se ofrecen en el catálogo sindicado del cliente, entre otros. | Responsabilidad compartida de IBM y el cliente |
...
|Instalar componentes de estructura, app y supervisión y gestión | Instalar, configurar y verificar componentes de estructura, como BOSH Director, Cloud Controller, Health Manager, mensajería, routers, CELL y proveedores de servicios y los componentes de supervisión definidos en el plan de escalamiento y detección de problemas. | IBM |
...
|Configurar un servidor de inicio de sesión | Configurar el servidor de registro para utilizarlo con SAML si es necesario. | IBM |
...
La etapa final de la finalización representa el final de la relación entre usted e {{site.data.keyword.Bluemix_notm}}. Las tareas principales de esta fase son las siguientes:
