...
|Servicios de la comunidad de {{site.data.keyword.Bluemix_dedicated_notm}}  | Un entorno que permite desplegar y ejecutar servicios de la comunidad hasta un total de 50 instancias para cada servicio de la comunidad.  |
...
<li>Seleccione el tipo de autenticación que se utilizará. Puede seleccionar entre IBMid y Active Directory. Para obtener información sobre cómo utilizar y registrarse para obtener un IBMid, consulte la página <a href="https://www.ibm.com/account/profile/us?page=regfaqhelp#4">Ayuda y preguntas frecuentes</a>.
</li>
...
Los representantes de los clientes trabajan con los especialistas de IBM que trabajan conjuntamente para asegurarse de que siempre tenga el soporte que necesita. Puede actualizar al nivel de soporte Premium para trabajar con un TAM (Technical Account Manager) dedicado para su cuenta. Para obtener más información sobre los distintos niveles de soporte, consulte [Tipos de soporte](/docs/get-support/getstarttssup.html#typesofsupport). El TAM completa los siguientes tipos de tareas:
...
**Nota**: No todos los servicios de {{site.data.keyword.Bluemix_notm}} admiten la distribución regional. Al construir una aplicación, si desea lograr la distribución geográfica, también debe asegurarse de que los servicios que se utilizan en la aplicación tienen la sincronización de datos como característica clave.
