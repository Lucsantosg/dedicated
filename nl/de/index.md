...
| Optional | [{{site.data.keyword.dashdbshort}}](/docs/services/Db2whc/index.html#getting_started) |IBM {{site.data.keyword.dashdbshort}} bietet einen vollständig verwalteten SQL-Clouddatenbankservice, der für Workloads aus einem Data-Warehouse und aus Analysen optimiert ist. |
| Optional | [{{site.data.keyword.Db2_on_Cloud_short}}](/docs/services/Db2onCloud/index.html#getting_started_db2oncloud) |IBM {{site.data.keyword.Db2_on_Cloud_short}} bietet einen vollständig verwalteten SQL-Clouddatenbankservice, der für allgemeine Zwecke, Web-Apps und transaktionsorientierte Workloads optimiert ist. |
...
|{{site.data.keyword.Bluemix_dedicated_notm}} {{site.data.keyword.Db2_on_Cloud_short}} Precise Performance 500 (2.8.500) | Die Dedicated-Instanz unterstützt Arbeitslasten für die Onlinetransaktionsverarbeitung (OLTP) von 8 GB RAM und 500 GB Speicher für Daten und Protokolle. |
|{{site.data.keyword.Bluemix_dedicated_notm}} {{site.data.keyword.Db2_on_Cloud_short}} Precise Performance 1400 (12.128.1400) | Die Dedicated-Instanz unterstützt Arbeitslasten für die Onlinetransaktionsverarbeitung (OLTP) von 128 GB RAM und 1,4 TB SSD-Speicher für Daten und Protokolle. |
|{{site.data.keyword.Bluemix_dedicated_notm}} {{site.data.keyword.Db2_on_Cloud_short}} Precise Performance 500 High Availability (2.8.500) | Die Dedicated-Instanz unterstützt Arbeitslasten für die Onlinetransaktionsverarbeitung (OLTP) von 8 GB RAM und 500 GB Speicher für Daten und Protokolle und enthält einen weiteren Standby-Server für eine Hochverfügbarkeit. |
|{{site.data.keyword.Bluemix_dedicated_notm}} {{site.data.keyword.Db2_on_Cloud_short}} Precise Performance 1400 High Availability (12.128.1400) | Die Dedicated-Instanz unterstützt Arbeitslasten für die Onlinetransaktionsverarbeitung (OLTP) von 128 GB RAM und 1,4 TB SSD-Speicher für Daten und Protokolle und enthält einen weiteren Standby-Server für eine Hochverfügbarkeit. |
...
|Konfigurieren eines Anmeldungsservers | Konfigurieren Sie den Anmeldungsserver für die Verwendung mit SAML, falls erforderlich. | IBM |
...
![Problembehebungsprozess](../local/images/incidentresponseprocess.svg "Problembehebungsprozess")
